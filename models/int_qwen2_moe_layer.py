    ...
    def __init__(
        ...
        if outlier_topk > 0:
            shared_gate_proj, shared_gate_outlier_proj, shared_gate_outlier_idx = _split_linear_outlier_columns(
                org_module.shared_expert.gate_proj, outlier_topk, args=args, layer_idx=layer_idx, expert_idx=-1
            )
            shared_up_proj, shared_up_outlier_proj, shared_up_outlier_idx = _split_linear_outlier_columns(
                org_module.shared_expert.up_proj, outlier_topk, args=args, layer_idx=layer_idx, expert_idx=-1
            )
